...
hielixir = Item("MegaElixer", "elixir", "Fully restores party's HP/MP", 9999)
...
while running:
    ...
    for player in players:
        ...
        if index == 0:
            ...
            print("You attacked for for", dmg, "points of damage.")
            ...
            if player.items[item_choice]["quantity"] == 0:
                print(bcolors.FAIL + "\n You have out of " + item.name + "s" + bcolors.ENDC)
                continue
